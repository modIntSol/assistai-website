        ...
        <div className="text-center mt-20">
          <div className="bg-card border border-border p-12 rounded-sm">
            ...
            <button 
              ...
              className="consultation-btn bg-primary text-primary-foreground px-8 py-4 rounded-sm font-semibold text-lg border border-border transition-colors duration-300"
            >
