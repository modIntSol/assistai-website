      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            <div className="bg-card p-6 rounded-sm border border-border border-l-4 border-l-foreground transition-transform duration-300 hover:scale-105 group">
              <div className="flex items-start">
                <div className="text-2xl mr-4">💬</div>
                <div>
                  <h4 className="font-semibold text-foreground mb-2 transition-colors duration-300 group-hover:text-white">AI-Powered Communication</h4>
                  <p className="text-muted-foreground transition-colors duration-300 group-hover:text-white">
            ...
            <div className="bg-card p-6 rounded-sm border border-border border-l-4 border-l-foreground transition-transform duration-300 hover:scale-105 group">
              <div className="flex items-start">
                <div className="text-2xl mr-4">🔧</div>
                <div>
                  <h4 className="font-semibold text-foreground mb-2 transition-colors duration-300 group-hover:text-white">Latest Technology Integration</h4>
                  <p className="text-muted-foreground transition-colors duration-300 group-hover:text-white">
            ...
            <div className="bg-card p-6 rounded-sm border border-border border-l-4 border-l-foreground transition-transform duration-300 hover:scale-105 group">
              <div className="flex items-start">
                <div className="text-2xl mr-4">✅</div>
                <div>
                  <h4 className="font-semibold text-foreground mb-2 transition-colors duration-300 group-hover:text-white">Cost-Effective Solutions</h4>
                  <p className="text-muted-foreground transition-colors duration-300 group-hover:text-white">
